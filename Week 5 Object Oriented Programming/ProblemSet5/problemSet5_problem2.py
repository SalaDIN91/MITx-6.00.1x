# -*- coding: utf-8 -*-
"""
Created on Wed Dec 13 02:00:38 2017
...
# 
# Implement the methods in the class PlaintextMessage according to the 
# specifications in ps6.py. The methods you should fill in are:
# 
# __init__(self, text, shift): Use the parent class constructor to make your code 
# more concise.
# The getter method get_shift(self)
# The getter method get_encrypting_dict(self): This should return a COPY of 
# self.encrypting_dict to prevent someone from mutating the original dictionary.
# The getter method get_message_text_encrypted(self)
# change_shift(self, shift): Think about what other methods you can use to make 
# this easier. It shouldn’t take more than a couple lines of code.
# =============================================================================
