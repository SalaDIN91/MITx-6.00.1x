# -*- coding: utf-8 -*-
"""
Created on Sat Dec  9 18:45:58 2017
...
# (4+1+4+3+1+1+1)*7=105, plus an additional 50 point bonus for 
# using all n letters).
# 
# 
# Hints
# You may assume that the input word is always either a string of 
# lowercase letters, or the empty string "".
...
# letters in the hand). Our goal is to keep the code modular - if you want to 
# try playing your word game with n=10 or n=4, you will be able to do it by 
# simply changing the value of HAND_SIZE!
# Testing: If this function is implemented properly, and you run test_ps4a.py, 
# you should see that the test_getWordScore() tests pass. Also test your 
# implementation of getWordScore, using some reasonable English words.
# Fill in the code for getWordScore in ps4a.py and be sure you've passed the 
