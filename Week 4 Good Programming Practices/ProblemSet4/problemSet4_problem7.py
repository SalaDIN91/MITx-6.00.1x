# -*- coding: utf-8 -*-
"""
Created on Sun Dec 10 20:50:44 2017
...
# comes from the code you wrote in playHand and compPlayHand - be sure that your 
# code is modular and uses function calls to these helper functions!
# 
...
# 
# Here is the above output, with the output from playHand and compPlayHand 
# obscured:
# 
# Enter n to deal a new hand, r to replay the last hand, or e to end game: r
...
# 
# A Note On Runtime
# You may notice that things run slowly when the computer plays. This is to be 
# expected. If you want (totally optional!), feel free to investigate ways of 
# making the computer's turn go faster - one way is to preprocess the word list 
# into a dictionary (string -> int) so looking up the score of a word becomes 
# much faster in the compChooseWord function.
# 
# Be careful though - you only want to do this preprocessing one time - probably 
# right after we generate the wordList for you (at the bottom of the file). If 
# you choose to do this, you'll have to modify what inputs your functions take 
# (they'll probably take a word dictionary instead of a word list, for example).
# 
# IMPORTANT:Don't worry about this issue when running your code in the checker 
# below! We load a very small sample wordList (much smaller than 83667 words!) 
# to avoid having your code time out. Your code will work even if you don't 
# implement a form of pre-processing as described.
# 
# Entering Your Code
# Be sure to only paste your definition for playGame from ps4b.py in the 
# following box. Do not include any other function definitions.
# 
# Note: the input function on Spyder may print an extra newline. That's ok. Do 
# not try to move text backwards using end='\b' in a print statement
# 
# =============================================================================
