# -*- coding: utf-8 -*-
"""
Created on Sun Dec 10 01:00:29 2017
...
# function. Check out the Why Pseudocode? resource to learn more about the 
# What and Why of Pseudocode before you start coding your solution.
# 
...
# implementation as if you were playing the game. Here is some example 
# output of playHand:
# 
# Test Cases
# Case #1
...
# Additional Testing
# Be sure that, in addition to the listed tests, you test the same basic test 
# conditions with varying values of n. n will never be smaller than the number 
